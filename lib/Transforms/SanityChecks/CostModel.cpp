...
//===----------------------------------------------------------------------===//
//
// Adapted from LLVM's Analysis/CostModel.cpp, so that we can use it from other
// passes. Functions are put into namespace sanitychecks to distinguish them
// from their LLVM counterparts.
// 
...
#define CM_NAME "sanity-check-cost-model"
#define DEBUG_TYPE CM_NAME

static cl::opt<bool> EnableReduxCost("sanity-check-cost-model-reduxcost", cl::init(false),
                                     cl::Hidden,
                                     cl::desc("Recognize reduction patterns."));

// Register this pass.
char CostModelAnalysis::ID = 0;
static RegisterPass<CostModelAnalysis> X(CM_NAME,
        "Cost Model Analysis", false, true);
...
void
CostModelAnalysis::initializePass() {
